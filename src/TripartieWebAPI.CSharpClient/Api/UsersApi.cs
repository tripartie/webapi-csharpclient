...
namespace TripartieWebAPI.CSharpClient.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <returns></returns>
        public UsersApi(TripartieWebAPI.CSharpClient.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Unregister Unregister a User using its External ID or Tripartie ID.&lt;br /&gt; You MUST provide either &lt;code&gt;external-id&lt;/code&gt; or &lt;code&gt;tripartie-id&lt;/code&gt;, but not both.&lt;br /&gt; This wont delete the User&#39;s Tripartie account. 
        /// </summary>
        /// <exception cref="TripartieWebAPI.CSharpClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalId">The User&#39;s External ID. (optional)</param>
        /// <param name="tripartieId">The User&#39;s Tripartie ID. (optional)</param>
        ...
        /// <summary>
        /// Fetch Fetch a User by its External ID or Tripartie ID.&lt;br /&gt; You MUST provide either &lt;code&gt;external-id&lt;/code&gt; or &lt;code&gt;tripartie-id&lt;/code&gt;, but not both. 
        /// </summary>
        /// <exception cref="TripartieWebAPI.CSharpClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalId">The User&#39;s External ID. (optional)</param>
        /// <param name="tripartieId">The User&#39;s Tripartie ID. (optional)</param>
        ...
        public ApiResponse<ModelUser> ApiWebUsersGetWithHttpInfo (string externalId = default(string), int? tripartieId = default(int?))
        {
            ...
            return new ApiResponse<ModelUser>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ModelUser) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ModelUser)));
        }
        ...
        public ApiResponse<ModelUser> ApiWebUsersPostWithHttpInfo (RequestRegisterUser requestRegisterUser)
        {
            ...
            if (requestRegisterUser != null && requestRegisterUser.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(requestRegisterUser); // http body (model) parameter
            }
            else
            {
                localVarPostBody = requestRegisterUser; // byte array
            }
