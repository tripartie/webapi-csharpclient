...
${nuget_cmd} install src/TripartieWebAPI.CSharpClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TripartieWebAPI.CSharpClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TripartieWebAPI.CSharpClient.dll \
-recurse:'src/TripartieWebAPI.CSharpClient/*.cs' \
-doc:bin/TripartieWebAPI.CSharpClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TripartieWebAPI.CSharpClient.dll was created successfully"
fi
